                    ...
                    <div class="our-history-content">
                        ...
                        <div class="explore-project-circle wow fadeInUp" data-wow-delay="0.4s">
                            <a href="projects.html">
                                <img src="./assets/images/explore-project-circle-accent.svg" alt="">
                            </a>
                        </div>
                    ...
                    <div class="history-item-list">
                        ...
                        <div class="history-item wow fadeInUp">
                            ...
                            <div class="history-item-image">
                                <figure>
                                    <img src="./assets/images/our-history-image-1.png" alt="">
                                </figure>
                            </div>
                        ...
                        <div class="history-item wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="history-item-image">
                                <figure>
                                    <img src="./assets/images/our-history-image-2.png" alt="">
                                </figure>
                            </div>
                            <!-- History Item Image End -->
                        </div>
                        ...
                        <div class="history-item wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="history-item-image">
                                <figure>
                                    <img src="./assets/images/our-history-image-3.png" alt="">
                                </figure>
                            </div>
                            <!-- History Item Image End -->
                        </div>
                        ...
                        <div class="history-item wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="history-item-image">
                                <figure>
                                    <img src="./assets/images/our-history-image-4.png" alt="">
                                </figure>
                            </div>
                            <!-- History Item Image End -->
                        </div>
        ...
        <div class="container">
            <div class="row section-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title section-title-center">
                        ...
                        <h2 class="text-anime-style-2" data-cursor="-opaque">Building success through a defined <span>construction process</span></h2>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                    <!-- Our Process Item Start -->
                    <div class="our-process-item box-1 wow fadeInUp">
                        <!-- Our Process Item Number Start -->
                        <div class="our-process-item-number">
                            <h2>01</h2>
                        </div>
                        <!-- Our Process Item Number End -->

                        <!-- Our Process Item Content Start -->
                        <div class="our-process-item-content">
                            <h3>Initial Consultation</h3>
                            <p>We begin by understanding your requirements, goals, budget, and timeline.</p>  
                            <ul>
                                <li>Construction</li>
                                <li>Real Estate</li>
                            </ul>
                        </div>  
                        <!-- Our Process Item Content End -->
                    </div>
                    <!-- Our Process Item End -->
                </div>

                <div class="col-xl-4 col-md-6">
                    <!-- Our Process Item Start -->
                    <div class="our-process-item box-2 wow fadeInUp" data-wow-delay="0.2s">
                        <!-- Our Process Item Header Start -->
                        ...
                        <!-- Our Process Item Header End -->

                        <!-- Our Process Item Image Start -->
                        <div class="our-process-item-image">
                            <figure>
                                <img src="./assets/images/our-procces-image-1.png" alt="">
                            </figure>
                        </div>
                        <!-- Our Process Item Image End -->
                    </div>
                    <!-- Our Process Item End -->
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <!-- Our Process Item Start -->
                    <div class="our-process-item box-3 wow fadeInUp" data-wow-delay="0.4s">
                        <!-- Our Process Item Number Start -->
                        <div class="our-process-item-number">
                            <h2>03</h2>
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-footer-text section-satisfy-img wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <p>Complete Real Estate And Construction Solutions<a href="contact.html">- Contact Us</a></p>
                        <ul>
...
<?php 
include "./components/career-cta.php";
